    ...
    public function index()
{
    ...
    $participations = Participation::with('event', 'participant')->paginate(5);
    ...
    public function reserve(Request $request, $eventId)
    {
        ...
        Participation::create([
            ...
            'is_paid' => $validated['option'] === 'pay', // Enregistrer true si 'pay', sinon false
        ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('flash_message', 'Participation annulée!');
    }
