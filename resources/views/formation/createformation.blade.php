...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        <div class="hero-section-text mt-5">
                            ...
                            <h1 class="hero-title text-black mt-4 mb-4">Add Formation! <br>welcome</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form action="{{ url('admin/dashboard/formations/createformation') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label>Name</label>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="specialite" class="form-control">
                                                            ...
                                                            <option value="formation professionnelle" {{ old('specialite') == 'formation professionnelle' ? 'selected' : '' }}>Formation Professionnelle</option>
                                                            <option value="formation touristique" {{ old('specialite') == 'formation touristique' ? 'selected' : '' }}>Formation Touristique</option>
                                                        </select>
    ...
    @error('formateur_id') <span class="text-danger">{{ $message }}</span> @enderror
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
    <img src="{{ asset('assets2/img/formation.webp') }}" alt="" style="margin-top: 300px;">
</div>
