...
<div class="content" style="position: relative; top: 100px;">
    <div class="container">
        <h1 class="mb-4">Modifier le Magasin</h1>
        ...
        <form action="{{ route('magasins.update', $magasin->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label>Promotions disponibles</label>
                        <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" id="no_promo" name="promo_choice" value="none" 
                                {{ $magasin->promotions->isEmpty() ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" id="with_promo" name="promo_choice" value="with"
                                {{ $magasin->promotions->isNotEmpty() ? 'checked' : '' }}>
                            <label class="form-check-label" for="with_promo">Avec promotion</label>
                        </div>

                        <div id="promotions_list" style="display: {{ $magasin->promotions->isNotEmpty() ? 'block' : 'none' }}">
                            @foreach($promotions as $promotion)
                                ...
                                <div class="form-check mb-2">
                                    ...
                                    <label class="form-check-label" for="promotion_{{ $promotion->id }}">
                                        ...
                                        @else
                                            <span class="text-muted">({{ $daysRemaining }} jours restants)</span>
                                        @endif
                                    </label>
                                </div>
                            @endforeach
