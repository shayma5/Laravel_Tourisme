...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('event/' . $events->id) }}" method="post" enctype="multipart/form-data">
      ...
      <label>Prix</label></br>
      <input type="number" name="price" step="0.01" value="{{ old('price', $events->price) }}" class="form-control">
      @if ($errors->has('price'))
      ...
      <input type="number" name="nbParticipant" value="{{ old('nbParticipant', $events->nbParticipant) }}" class="form-control">
